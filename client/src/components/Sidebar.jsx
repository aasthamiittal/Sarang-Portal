...
const Sidebar = ({ isOpen, setOpen }) => {
  ...
  return (
    <>
      ...
      ></div>
      <div className={`fixed inset-y-0 left-0 z-50 w-64 bg-gray-800 text-white p-4 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} transition-transform duration-300 lg:static lg:inset-auto lg:z-auto lg:transform-none lg:translate-x-0`}>
